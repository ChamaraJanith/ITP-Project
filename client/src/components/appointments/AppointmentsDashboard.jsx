...
const Appointment = () => {
  ...
  const [consultationFee, setConsultationFee] = useState(5000); // Default fee
  ...
  // **NEW: Update fee when specialty changes**
  useEffect(() => {
    if (formData.doctorSpecialty) {
      const fee = calculateConsultationFee(formData.doctorSpecialty);
            ...
            <div className="form-step">
              ...
              {formData.doctorSpecialty && (
                <div className="fee-display">
                  <div className="fee-card">
                    ...
                    <span className="fee-amount">${consultationFee.toLocaleString()}</span>
                  </div>
                </div>
              )}
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  >
                    ...
                    <option value="General Physician">General Physician ($4,000)</option>
                    <option value="Cardiologist">Cardiologist - Heart Specialist ($6,000)</option>
                    <option value="Dermatologist">Dermatologist - Skin Specialist ($5,500)</option>
                    <option value="Neurologist">Neurologist - Brain & Nerve Specialist ($7,000)</option>
                    <option value="Pediatrician">Pediatrician - Child Specialist ($4,500)</option>
                    <option value="Orthopedic">Orthopedic Surgeon - Bone & Joint ($6,000)</option>
                    <option value="Gynecologist">Gynecologist - Women's Health ($5,500)</option>
                    <option value="Psychiatrist">Psychiatrist - Mental Health ($6,500)</option>
                    <option value="Dentist">Dentist - Dental Care ($3,500)</option>
                    <option value="Eye Specialist">Ophthalmologist - Eye Specialist ($5,000)</option>
                    <option value="ENT">ENT Specialist - Ear, Nose, Throat ($4,800)</option>
                  </select>
                </div>
              ...
              <div className="form-actions">
                ...
                <button 
                  ...
                  disabled={loading}
                >
                  {loading ? 'Booking Your Appointment...' : `Book Appointment & Pay $${consultationFee.toLocaleString()}`}
                </button>
              </div>
            </div>
          )}
